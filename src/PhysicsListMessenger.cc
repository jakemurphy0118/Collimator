...
:pPhysicsList(pPhys)
{
  setBFieldCmd = new G4UIcmdWithADouble("/lena/phys/setBField",this);  
  //  gammaCutCmd->SetGuidance("Set gamma cut.");
  setBFieldCmd->SetParameterName("Gcut",false);
                                          ...
                                          G4String newValue)
{
  if( command == setBFieldCmd )
   { pPhysicsList->SetBField(setBFieldCmd->GetNewDoubleValue(newValue));}
